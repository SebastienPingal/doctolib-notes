document.addEventListener('DOMContentLoaded', async () => {
  ...
  try {
    ...
    switch(pageType) {
      case "search":
        updateStatus("Extension active - Page de recherche de médecins", 'active')
        break
      case "profile":
        updateStatus("Extension active - Page de profil médecin", 'active')
        break
      default:
        updateStatus("Extension active - Naviguez vers une page compatible", null)
    }
  } catch (error) {
